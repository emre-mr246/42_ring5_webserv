...
SRCS        = main.cpp error.cpp extract.cpp parserUtils.cpp debug.cpp parser.cpp utils.cpp pollManager.cpp connectionHandler.cpp eventLoop.cpp socket.cpp config.cpp
HDRS        = webserv.hpp
